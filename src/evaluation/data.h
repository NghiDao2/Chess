...
const int piece_value_mg[7] = {124, 781, 825, 1276, 2538, 60000};
const int piece_value_eg[7] = {206, 854, 915, 1380, 2682, 60000};
const int square_table_mg[6][64] = {
...
const int square_table_eg[6][64] = {
...
const std::vector<std::vector<int>> mobility_mg = {
    {},
...
const std::vector<std::vector<int>> mobility_eg = {
    {},
